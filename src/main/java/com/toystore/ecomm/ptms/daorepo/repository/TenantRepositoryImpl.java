...
import com.toystore.ecomm.ptms.daorepo.exception.DatabaseCreationException;
...
public class TenantRepositoryImpl implements TenantRepositoryCustom {
	...
	public void createDbSchemaNTables(String newDbName) {
		try {
				...
				query = em.createNativeQuery("CREATE TABLE IF NOT EXISTS " + newDbName + ".USER (USER_ID int(10) NOT NULL AUTO_INCREMENT, FIRST_NAME varchar(45) DEFAULT NULL, LAST_NAME varchar(45) DEFAULT NULL, MIDDLE_NAME varchar(45) DEFAULT NULL, EMAIL_ID varchar(45) DEFAULT NULL, PRIMARY_CONTACT varchar(10) DEFAULT NULL, PRIMARY KEY (USER_ID))");
